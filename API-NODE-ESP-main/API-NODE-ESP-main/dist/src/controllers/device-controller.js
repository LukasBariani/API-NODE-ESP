...
exports.deleteDevice = exports.getDeviceById = exports.postDevice = exports.getDevice = void 0;
const service = __importStar(require("../services/device-service"));
const http_helper_1 = require("../../utils/http-helper");
const getDevice = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const httpResponse = yield service.getDeviceService();
    res.status(httpResponse.statusCode).json(httpResponse.body);
});
exports.getDevice = getDevice;
const postDevice = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const bodyValue = req.body;
    const httpResponse = yield service.createDeviceService(bodyValue);
    if (httpResponse) {
        res.status(httpResponse.statusCode).json(httpResponse.body);
    }
    else {
...
const getDeviceById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    //console.log(id);
    const httpResponse = yield service.getDeviceByIdService(id);
    res.status(httpResponse.statusCode).json(httpResponse.body);
});
exports.getDeviceById = getDeviceById;
const deleteDevice = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const id = parseInt(req.params.id);
    const httpResponse = yield service.deleteDeviceService(id);
    res.status(httpResponse.statusCode).json(httpResponse.body);
});
